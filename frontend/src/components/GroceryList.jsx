...
const GroceryList = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get("http://127.0.0.1:8000/groceryitems/");
            console.log('Fetched grocery items:', response.data);  // Veri çekme işlemini doğrulamak için log ekleyin
    ...
    const handleCreate = async () => {
        try {
            const response = await axios.post("http://127.0.0.1:8000/groceryitems/", newGroceryItem);
    ...
    const handleUpdate = async () => {
        try {
            const response = await axios.put(`http://127.0.0.1:8000/groceryitems/${editGroceryItem.id}/`, editGroceryItem);
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`http://127.0.0.1:8000/groceryitems/${id}/`);
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <form>
                                ...
                                <button type="button" className="btn btn-primary my-4" onClick={handleCreate}>
                                    Create Grocery Item
                                </button>
                            </form>
                        </div>
